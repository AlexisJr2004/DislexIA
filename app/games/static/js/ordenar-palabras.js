...
class OrdenarPalabrasGame {
    ...
    handleCorrectAnswer(responseTime) {
        this.correctAnswers++;
        console.log(`✅ [Ordenar] correctAnswers incrementado a: ${this.correctAnswers}`); // ⭐ AGREGAR
    ...
    handleIncorrectAnswer() {
        if (this.attempts >= 3) {
            ...
            console.log(`❌ [Ordenar] incorrectAnswers incrementado a: ${this.incorrectAnswers}`); // ⭐ AGREGAR
            this.stopQuestionTimer();
            this.isGameActive = false;
            // ... resto del código
    ...
    async finishGame() {
        ...
        if (result && result.success) {
            console.log('✅ [Ordenar Palabras] Juego finalizado correctamente');
        } else {
    ...
    async sendGameResults(totalTimeSeconds) {
        ...
        console.log(`📊 [Ordenar] RESUMEN FINAL:`); // ⭐ AGREGAR
        console.log(`   correctAnswers: ${this.correctAnswers}`);
        console.log(`   incorrectAnswers: ${this.incorrectAnswers}`);
        ...
        console.log('📤 [Ordenar Palabras] Enviando resultados finales:', data);
